...
Non-logging DoH server in France operated by St茅phane Bortzmeyer.
...
Non-logging DoH server in France operated by St茅phane Bortzmeyer (IPv6 only).
...
DNS-over-HTTPS DNS forwarder from Mumbai, India 馃嚠馃嚦.
...
## dnscry.pt-chi葯in膬u-ipv4

DNSCry.pt Chi葯in膬u - no filter, no logs, DNSSEC support (IPv4 server)
...
## dnscry.pt-chi葯in膬u-ipv6

DNSCry.pt Chi葯in膬u - no filter, no logs, DNSSEC support (IPv6 server)
...
## dnscry.pt-d眉sseldorf-ipv4

DNSCry.pt D眉sseldorf - no filter, no logs, DNSSEC support (IPv4 server)
...
## dnscry.pt-d眉sseldorf-ipv6

DNSCry.pt D眉sseldorf - no filter, no logs, DNSSEC support (IPv6 server)
...
DNSSEC 鈥� OpenNIC 鈥� Non-logging 鈥� Uncensored - hosted on ovh.com.au
